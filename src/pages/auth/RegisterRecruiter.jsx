...
function Register() {
  ...
  const handleRegister = async (e) => {
    e.preventDefault();
    try {
      await api.post("/recruiters/register", dataRegister);
          ...
          <div className="w-full lg:w-full flex flex-col justify-center p-4 md:p-8">
            ...
            <div className="flex md:flex-row items-center gap-2 mb-8 md:mb-12">
              <Link to="/auth/register-worker">
                <button className="px-6 py-3 bg-white hover:bg-hoverPrimary hover:text-white text-primary border-solid border-2 border-primary font-bold">Worker</button>
              </Link>

              <Link to="/auth/register-recruiter">
                <button className="px-6 py-3 bg-primary hover:bg-hoverPrimary text-white border-solid border-2 border-primary font-bold">Recruiter</button>
              </Link>
            </div>
            ...
            <form onSubmit={handleChanges} className="flex h-[40vh] flex-col gap-8 md:gap-8 mb-8 md:mb-12">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setDataRegister({ ...dataRegister, company: e.target.value })}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setDataRegister({ ...dataRegister, position: e.target.value })}
                />
              </div>
              <div>
              ...
              <div>
                <button type="submit" onClick={handleRegister} className=" w-full border-2 p-3 outline-primary rounded-md bg-accent hover:bg-hoverAccent font-bold text-white mb-10 ">
                  Daftar
                </button>
