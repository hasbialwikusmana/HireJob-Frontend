  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const workExperiencesResponse = await api.get(`/experience/${id}`);

        const portfoliosResponse = await api.get(`/portfolio/${id}`);
    ...
    <>
      <div className="container-fluid bg-primary w-full h-[55vh] ">
        ...
        <div className="container-edit pt-20 flex flex-col md:flex-row md:items-start justify-center  mt-10 pb-12 lg:gap-10 md:gap-10 sm:gap-0 ">
                ...
                <div className="flex flex-col justify-center items-center pb-10">
                  ...
                  <div className="desc mt-8 w-full pl-4">
                    ...
                    <div className="wrapper-btn-hire mt-8">
                      <Link to={`/hire/${id}`}>
                        <button className="text-white bg-primary hover:bg-hoverPrimary w-full p-2 rounded-md">Hire</button>
                      </Link>
                    </div>
                    ...
                    <div className="wrapper contact mt-10">
                      ...
                      {/* <div className="mail flex items-center gap-3 mb-4">
                        <FaEnvelope className="text-textSecondary  w-6" />
                        <p className="text-gray-600 text-[14px] leading-5">Louistommo@gmail.com</p>
                      </div>
                      <div className="instagram flex items-center gap-3 mb-4">
                        <FaInstagram className="text-textSecondary  w-6" />
                        <p className="text-gray-600 text-[14px] leading-5">@Louist91</p>
                      </div>
                      <div className="Github flex items-center gap-3 mb-4">
                        <FaGithub className="text-textSecondary  w-6" />
                        <p className="text-gray-600 text-[14px] leading-5">@Louistommo</p>
                      </div>
                      <div className="gitlab flex items-center gap-3">
                        <FaGitlab className="text-textSecondary  w-6" />
                        <p className="text-gray-600 text-[14px] leading-5">@Louistommo91</p>
                      </div> */}
                    </div>
                  </div>
                </div>
          ...
          <section>
            <div className="container-edit-profile p-8 mt-8 md:mt-0 sm:mt-0 w-full  bg-white md:w-[753px] h-auto shadow-lg rounded-md">
                      ...
                      <div className="wrapper-card mt-4">
                        {workExperiences.map((workExperiences, index) => (
                          <div key={index} className="flex items-start gap-4 md:gap-14 mt-6 md:mt-10">
                            <img src={buildingImage} alt="icon perusahaan" className="w-[90px] h-[90px] object-cover rounded-md" />
