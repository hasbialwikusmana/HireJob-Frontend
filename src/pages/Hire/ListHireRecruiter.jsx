                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              <div className="flex-shrink-0 h-10 w-10">
                                <img className="h-10 w-10 rounded-full" src={profile.worker_photo} alt="" />
                              </div>
                              <div className="ml-4">
                                <div className="text-sm font-medium text-gray-900">{profile.worker_name}</div>
                                <div className="text-sm text-gray-500">{profile.worker_workplace}</div>
                                <div className="text-sm text-gray-500">{profile.worker_job_desk}</div>
                              </div>
                            </div>
                          </td>
                        </tr>
                ...
                {!selectedProfile ? (
                  ...
                  <div>
                    <div className="flex flex-col items-center text-center">
                      <img className="h-24 w-24 rounded-full" src={selectedProfile?.worker_photo} alt="" />
                      <h3 className="mt-4 font-bold text-lg">{selectedProfile?.worker_name}</h3>
                      <p className="text-sm text-gray-600">{selectedProfile?.worker_workplace}</p>
                      <p className="text-sm text-gray-600">{selectedProfile?.worker_job_desk}</p>
                      <Link to={`/profile/${selectedProfile?.worker_id}`} className="bg-primary hover:bg-hoverPrimary text-white font-bold py-2 px-4 rounded mt-4">
                        Lihat Detail
                      </Link>
                    </div>
